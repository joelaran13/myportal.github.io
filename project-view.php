                ...
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row align-items-center">
							<div class="col">
								<h3 class="page-title">Report Title(All is non function, for GUI preview only)</h3>
								<ul class="breadcrumb">
							...
							<div class="col-auto float-right ml-auto">
								<a href="#" class="btn add-btn" data-toggle="modal" data-target="#edit_project"><i class="fa fa-plus"></i> Edit Report</a>
								<a href="task-board.php" class="btn btn-white float-right m-r-10" data-toggle="tooltip" title="Delete Report"><i class="fa fa-bars"></i></a>
							</div>
						</div>
					</div>
					<!-- /Page Header -->
								...
								<div class="card-body">
									...
									<table class="table table-striped table-border">
										<tbody>
											<tr>
												<td>Cost:</td>
												<td class="text-right">RM 1200</td>
											</tr>
											<tr>
												<td>Total Hours:</td>
											...
											<tr>
												<td>Created:</td>
												<td class="text-right">25 Feb, 2025</td>
											</tr>
											<tr>
												<td>Deadline:</td>
												<td class="text-right">12 Jun, 2025</td>
											</tr>
											<tr>
												<td>Priority:</td>
												<td class="text-right">
											...
											<tr>
												<td>Created by:</td>
												<td class="text-right"><a href="profile.php">John Doe</a></td>
											</tr>
											<tr>
												<td>Status:</td>
