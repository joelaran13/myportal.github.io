...
<html lang="en">
    <head>
        ...
        <title>Profile - LAK Internship</title>
    ...
    <body>
        ...
        <div class="main-wrapper">
			...
			<!-- Sidebar -->
            <?php include_once("includes/employee_sidebar.php");?>
			<!-- /Sidebar -->
											...
											<div class="row">
												<div class="col-md-5">
													<div class="profile-info-left">
														...
														<h6 class="text-muted">Website Dev/Design</h6>
														<small class="text-muted">Web Designer</small>
														<div class="staff-id">Employee ID : FT-0001</div>
														<div class="small doj text-muted">Date of Join : 1st August 2024</div>
												...
												<div class="col-md-7">
													<ul class="personal-info">
														<li>
															...
															<div class="text"><a href="">0123456789</a></div>
														</li>
														<li>
