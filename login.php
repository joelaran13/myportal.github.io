			...
			<div class="account-content">
				<div class="container">
					...
					<div class="account-logo">
						<a href="index.php"><img src="assets/img/logo_lak.png" alt="Company Logo"></a>
					</div>
					<!-- /Account Logo -->
						...
						<div class="account-wrapper">
							...
							<form method="POST" enctype="multipart/form-data">
								...
								<div class="account-footer">
									<p>Employee login page <a target="employee_login.php" href="employee_login.php">Login</a></p>
								</div>
							</form>
							<!-- /Account Form -->
