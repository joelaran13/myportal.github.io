...
<html lang="en">
    <head>
        ...
        <title>Employee Profile - LAK Internship</title>
											...
											<div class="row">
												<div class="col-md-5">
													<div class="profile-info-left">
														<h3 class="user-name m-t-0 mb-0"><?php echo $_SESSION['userlogin']; ?></h3>
						...
						<div class="row user-tabs">
							<div class="col-lg-12 col-md-12 col-sm-12 line-tabs">
								<ul class="nav nav-tabs nav-tabs-bottom">
									...
									<li class="nav-item"><a href="#emp_projects" data-toggle="tab" class="nav-link">Reports</a></li>
									<li class="nav-item"><a href="#bank_statutory" data-toggle="tab" class="nav-link">Marking & Certs <small class="text-danger">(Admin Only)</small></a></li>
								</ul>
							</div>
						</div>
					</div>
								...
								<div class="card-body">
									...
									<form>
										<div class="row">
											<div class="col-sm-4">
												<div class="form-group">
													...
													<div class="input-group"><input type="text" class="form-control" placeholder="How many days?" value="">
												</div>
											   </div>
											</div>
											<div class="col-sm-4">
												<div class="form-group">
													<label class="col-form-label">Points <small class="text-muted">per day</small></label>
													<div class="input-group">
														<div class="input-group-prepend">
															<span class="input-group-text">Each</span>
														</div>
														<input type="text" class="form-control" placeholder="Each day points" value="">
													</div>
												</div>
											</div>
										...
										<div class="row">
											<div class="col-sm-4">
												<div class="form-group">
													<label class="col-form-label">Submit report daily</label>
													<input type="text" class="form-control" placeholder="Max : 40%" value="">
												</div>
											</div>
											<div class="col-sm-4">
												<div class="form-group">
													<label class="col-form-label">Positive attitude in working<span class="text-danger">*</span></label>
													<input type="text" class="form-control" placeholder="Max : 10%" value="">
												</div>
											</div>										
											<div class="col-sm-4">
												<div class="form-group">
											...
											<div class="col-sm-4">
												<div class="form-group">
													<label class="col-form-label">Teamwork</label>
													<input type="text" class="form-control" placeholder="Max : 10%" value="">
												</div>
											</div>
											<div class="col-sm-4">
											...
											<div class="col-sm-4">
												<div class="form-group">
													...
													<input type="text" class="form-control" placeholder="N/A" value="">
												</div>
											</div>
									   </div>
																			
										<hr>
										<h3 class="card-title"> Remarks/Memo</h3>
										<div class="row">
											<div class="col-sm-4">
												<div class="form-group">
										...
										<div class="submit-section">
											<button class="btn btn-primary submit-btn" type="submit">Approved & Saved</button>
										</div>
									</form>
								</div>
							</div>
