<?php 
	...
	$userName = $_SESSION['userlogin']; // Assuming the session variable contains the username
	$currentDate = date('l, d F Y'); // Format: Monday, 20 May 2019
?>
<!DOCTYPE html>
<html lang="en">
    <head>
        ...
        <title>Dashboard - LAK Internship</title>
						...
						<div class="col-md-12">
							<div class="welcome-box">
								...
								<div class="welcome-det">
									<h3>Welcome, <?php echo htmlentities($userName); ?></h3>
									<p><?php echo htmlentities($currentDate); ?></p>
								</div>
							</div>
						</div>
					</div>
