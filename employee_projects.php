...
<html lang="en">
    <head>
        ...
        <title>Reports - LAK Internship</title>
						...
						<div class="row align-items-center">
							...
							<div class="col-auto float-right ml-auto">
								...
								<div class="view-icons">
									<a href="employee_projects.php" class="grid-view btn btn-link active"><i class="fa fa-th"></i></a>
									<a href="employee-project-list.php" class="list-view btn btn-link"><i class="fa fa-bars"></i></a>
								</div>
							</div>
						</div>
					</div>
